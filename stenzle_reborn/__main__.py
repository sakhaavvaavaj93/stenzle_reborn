...
from stenzle_reborn.modules import ALL_MODULES
from stenzle_reborn.modules.helper_funcs.chat_status import is_user_admin
from stenzle_reborn.modules.helper_funcs.misc import paginate_modules
...
PM_START_TEXT = """
ʜᴇʟʟᴏ [🤗](https://telegra.ph/file/c2501751eab062f45f59b.jpg), stenzle_reborn is a cutie puppy bot of kk . then she can do anything in tg . she can protect groups from the spammers . y .you can add me as a admin and really enjoy me .and try to understand my wonderful features.
...
HELP_STRINGS = """
`stenzle_reborn[🙋‍♀️](https://telegra.ph/file/c2501751eab062f45f59b.jpg)
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("stenzle_reborn.modules." + module_name)
    ...
    if query.data == "amelia_":
        query.message.edit_text(
            text=""" ℹ️ I'm *amelia*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \nHere is the [💾Repository](https://github.com/war-legend/stenzle_reborn).
