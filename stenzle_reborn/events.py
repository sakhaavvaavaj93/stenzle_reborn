...
from stenzle_reborn import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"stenzle_reborn/modules/{shortname}.py")
        name = "stenzle_reborn.modules.{}".format(shortname)
        ...
        mod.stenzle_reborn = stenzle_reborn
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["stenzle_reborn.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "stenzle_reborn/modules/*.py"
